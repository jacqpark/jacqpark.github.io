...
<div class="publication-entry">
  <div class="pub-title">
    {% if pub.github_pdf %}<a href="https://github.com/{{ site.github_username }}/{{ site.github_username }}.github.io/raw/main/{{ pub.github_pdf }}#view">{{ pub.title }}</a>{% else %}{{ pub.title }}{% endif %}
  </div>
  {% if pub.authors %}<div class="pub-authors">{{ pub.authors }}</div>{% endif %}
  ...
  {% endif %}
  <div class="pub-links">
    {% if pub.github_pdf %}<a href="https://github.com/{{ site.github_username }}/{{ site.github_username }}.github.io/raw/main/{{ pub.github_pdf }}#view" class="pub-link" target="_blank">Latest Draft</a>{% endif %}
    {% if pub.pdf_url %}<a href="{{ pub.pdf_url }}" class="pub-link" target="_blank">PDF</a>{% endif %}
  </div>
</div>
{% endfor %}
